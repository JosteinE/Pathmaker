...
//	}
	...
	void rebuild()
	{
		...
		for (int i = 0;  i < pathKeys.size(); i++)
		{
			...
			pathEntry.getPathLabel().addMouseListener(new DropAdapter(plugin.getStoredPaths(), groupNames, pathView, pathEntry, i, pathLabel, PANEL_MARGIN));
...
//
//		if (entryPosY < minY + DRAG_DROP_Y_MARGIN)
//		{
//			return 1;
//		}
//		if (entryPosY > maxY - DRAG_DROP_Y_MARGIN)
//		{
//			return -1;
//		}
//		return 0;
...
//				if (!isIndexValidDropTarget(panelIndex, targetIndex))
//				{
//					return;
//				}
//
...
//							if (targetPath.pathGroup.equals(draggedPath.pathGroup))
//							{
//								return;
//							}
